...
d3.csv("../data/recomendaciones_lightfm.csv", d3.autoType).then(joinRecomendaciones)
d3.csv("../data/ubicacion_postulantes.csv", d3.autoType).then(joinPostulantes)
...
function joinRecomendaciones(datos) {
    d3.json("../data/comunas_ps.geojson").then(datosComunas => {
    const proyeccion = d3.geoMercator()
