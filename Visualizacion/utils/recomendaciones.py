...
with open('../data/recomendaciones_als.json') as file:
    recomendaciones_als = json.load(file)

with open('../data/recomendaciones_lightfm.json') as file:
    recomendaciones_lightfm = json.load(file)

with open('../data/recomendaciones_mp.json') as file:
    recomendaciones_mp = json.load(file)


with open('../data/recomendaciones_random.json') as file:
    recomendaciones_random = json.load(file)

df_postulantes = pd.read_csv('../data/Postulantes.csv', encoding='utf-8', sep=';')
df_establecimientos = pd.read_csv('../data/informacion_establecimientos.csv', encoding='utf-8', sep=',')
...
df_ubicaciones_lightfm.to_csv('../data/recomendaciones_lightfm.csv', encoding='utf-8', sep=',', index=False)
df_ubicaciones_als.to_csv('../data/recomendaciones_als.csv', encoding='utf-8', sep=',', index=False)
df_postulantes.to_csv('../data/ubicacion_postulantes.csv', encoding='utf-8', sep=',', index=False)
df_ubicaciones_mp.to_csv('../data/recomendaciones_mp.csv', encoding='utf-8', sep=',', index=False)
df_ubicaciones_random.to_csv('../data/recomendaciones_random.csv', encoding='utf-8', sep=',', index=False)
