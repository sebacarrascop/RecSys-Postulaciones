...
with open('../data/comunas_ps.geojson', encoding='utf-8') as f:
  datos = json.load(f)
  print("Datos Leídos")
...
archivo = pd.read_csv('../data/postulaciones.csv', encoding='utf-8')
print("Archivo leído")
...
print("Leyendo archivo csv...")
archivo = pd.read_csv('../data/Oferta.csv', encoding='utf-8', sep=';')
...
establecimientos = pd.read_csv('../data/informacion_establecimientos.csv', encoding='utf-8')  
...
establecimientos.to_csv('../data/informacion_establecimientos.csv', index=False)
...
print("Leyendo archivo csv...")
archivo = pd.read_csv('../data/informacion_establecimientos.csv', encoding='utf-8')
print("Archivo leído")
...
with open('../data/comunas_ps.geojson', 'w') as f:
